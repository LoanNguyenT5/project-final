...
<html>
    ...
    <body>
        ...
        <!-- Shop Details Section Begin -->
        <section style="padding-top: 94px;padding-bottom: 0;"class="shop-details">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="product__details__breadcrumb">
                                ...
                                <a href="<c:url value="/shopp"/>">Shop</a>
            ...
            <mvc:form action="${pageContext.request.contextPath}/login" 
                                ...
                                <div class="col-lg-8">
                                    <div class="product__details__text">
                                        ...
                                        <div class="product__details__btns__option">
                                            <a href="<c:url value="/login"/>"><i class="fa fa-heart"></i> add to wishlist</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <a href="<c:url value="/details/${product.id}"/>" class="add-cart">+ Add To Cart</a>
                                    <div class="rating">
                                        <i class="fa fa-star-o"></i>
                                        <i class="fa fa-star-o"></i>
                                        <i class="fa fa-star-o"></i>
