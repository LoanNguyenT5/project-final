    ...
    <body>
        ...
        <section class="hero">
            <div class="hero__slider owl-carousel">
                <div id="hinh" class="hero__items set-bg" data-setbg="<c:url value="/resources/img/hero/hero-2.jpg"/>">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-5 col-lg-7 col-md-8">
                                <div class="hero__text">
                                    ...
                                    <p id="mota">A specialist label creating luxury essentials. Ethically crafted with an unwavering
                                        commitment to exceptional quality.</p>
<!--                                    <i class="fa fa-chevron-circle-left" onclick="before()"></i>
                                    <i class="fa fa-chevron-circle-right" onclick="after()"></i>-->
                                    <a href="<c:url value="/shopp"/>" class="primary-btn">Shop now <span class="arrow_right"></span></a>
                                ...
                                <c:forEach items="${p.images}" begin="0" end="0" var="i">
                                    <div class="product__item__pic set-bg" data-setbg="<c:url value="/resources/img/product/${i.getName()}"/>">
                                        ...
                                        <ul class="product__hover">
                                            ...
                                            <li><a href="<c:url value="/login"/>"><img src="<c:url value="/resources/img/icon/cart.png"/>" alt=""></a></li>
                                        </ul>
                                    </div>
                                </c:forEach>
