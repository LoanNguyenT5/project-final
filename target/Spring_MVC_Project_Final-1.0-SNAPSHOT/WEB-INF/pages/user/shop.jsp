                                                ...
                                                <div class="product__item">
                                                    <div class="product__item__pic set-bg">
                                                        ...
                                                        <ul class="product__hover">
                                                            <li><a href="<c:url value="/user/add-to-favorite/${p.id}"/>"><img style="" src="<c:url value="/resources/img/icon/heart.png"/>" alt=""></a></li>
                                                    ...
                                                    <div class="product__item__text">
                                                        ...
                                                        <div style="height: 47px;
                                                             overflow-y: hidden;color:black;font-size: 16px;">
                                                            ${p.description} 
                                                        </div>
                                                        <h5>$${p.price}</h5>
