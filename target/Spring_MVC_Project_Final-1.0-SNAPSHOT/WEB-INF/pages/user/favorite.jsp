...
<html>
    ...
    <%
        if (session.getAttribute("listFP") != null) {
            List<ProductEntity> listFP = (List<ProductEntity>) session.getAttribute("listFP");
        }
                                        ...
                                        <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                            <div class="card-body">
                                                <div class="shop__sidebar__brand">
                                                    <ul>
                                                        <li><a href="<c:url value="/branding?searchKey=Louis Vuitton&b=0"/>">Louis Vuitton</a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="shop__product__option__left">
                                        <c:if test="${fn:length(listFP)>0}">
                                            <p>Showing ${currentPage*12+1}–${currentPage*12+fn:length(listFP)} of ${sum} results</p>
                                        </c:if>
                                        <c:if test="${fn:length(listFP)<=0}">
                                                ...
                                                <div class="product__item">
                                                    <div class="product__item__pic set-bg">
                                                        ...
                                                        <ul class="product__hover">
                                                            <li><a href="<c:url value="/user/delete-favorite/${p.id}"/>"><img style="background-color: red;" src="<c:url value="/resources/img/icon/heart.png"/>" alt=""></a></li>
                                                    ...
                                                    <div class="product__item__text">
                                                        <h6>${p.name}</h6>
                                                        <!--                                                        <span><label for="id-of-input" class="custom-checkbox">
                                                                                                                        <input type="checkbox" id="id-of-input"/>
                                                                                                                        <i style="font-size:35px;    margin-left: 235px;
                                                                                                                           top: -39px;"class="glyphicon glyphicon-star-empty"></i>
                                                                                                                        <i style="font-size:35px;    margin-left: 235px;
                                                                                                                           top: -39px;"class="glyphicon glyphicon-star"></i>
                                                                                                                        <span></span>
                                                                                                                    </label></span>-->
                                                        <a href="<c:url value="/details/${p.id}"/>" class="add-cart">+ Add To Cart</a>
